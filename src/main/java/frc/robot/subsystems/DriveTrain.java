...
addChild("DistanceSensor",distanceSensor);

        
leftFrontMotor = new PWMVictorSPX(1);
...
rightFrontMotor = new PWMVictorSPX(3);
addChild("RightFrontMotor",rightFrontMotor);
rightFrontMotor.setInverted(false);
        
rightBackMotor = new PWMVictorSPX(4);
addChild("RightBackMotor",rightBackMotor);
rightBackMotor.setInverted(false);
        
tankDriveTrain = new RobotDrive(leftFrontMotor, leftBackMotor,
rightFrontMotor, rightBackMotor);

tankDriveTrain.setSafetyEnabled(true);
tankDriveTrain.setExpiration(0.1);
tankDriveTrain.setSensitivity(0.5);
tankDriveTrain.setMaxOutput(1.0);
